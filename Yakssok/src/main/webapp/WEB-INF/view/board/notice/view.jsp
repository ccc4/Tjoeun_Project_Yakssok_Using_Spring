	...
	<div style="width: 100%">
		...
		<article>
			...
			<div>
				...
				<input type="button" class="btn btn-success pull-left" value="목록" onclick="location.href='${pageContext.request.contextPath }/board/notice'">
				...
				<c:if test="${!empty loginMember && loginMember.m_idx == result.m_idx }">
					...
					<button type="button" class="btn btn-primary pull-right" onclick="location.href='${pageContext.request.contextPath }/board/notice/modify/${result.b_idx }'">수정</button>
				</c:if>
			</div>
			<!-- 게시글 보기 끝 -->
...
<script type="text/javascript">
	function check_delete() {
		...
		if(check == 1) {
			location.href='${pageContext.request.contextPath }/board/notice/delete/${result.b_idx }';
		} else{
			return false;
		}
	}

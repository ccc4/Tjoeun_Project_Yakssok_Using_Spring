					...
					<nav style="text-align: center;">
						<ul class="pagination pagination-sm">
							...
							<c:if test="${p.page != p.startPage }">
								<c:if test="${empty p.option }">
									<li><a href="${pageContext.request.contextPath }/board/share?page=${p.page - 1}">이전</a></li>
								</c:if>
								<c:if test="${!empty p.option }">
									<li><a href="${pageContext.request.contextPath }/board/share?page=${p.page - 1}&option=${p.option}&keyword=${p.keyword}">이전</a></li>
								</c:if>
							</c:if>
							<c:if test="${p.page == p.startPage }">
							...
							<c:if test="${p.page != p.totalPage }">
								<c:if test="${empty p.option }">
									<li><a href="${pageContext.request.contextPath }/board/share?page=${p.page + 1}">다음</a></li>
								</c:if>
								<c:if test="${!empty p.option }">
									<li><a href="${pageContext.request.contextPath }/board/share?page=${p.page + 1}&option=${p.option}&keyword=${p.keyword}">다음</a></li>
								</c:if>
							</c:if>
							<c:if test="${p.page == p.totalPage }">
